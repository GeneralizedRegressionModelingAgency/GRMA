...
\begin{figure}
\centering
\includegraphics{Bookdown_files/figure-latex/linearscatterplot-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Bookdown_files/figure-latex/linearline-1.pdf}
...
\begin{verbatim}
##           y     x1    x2
## 1 -786.7001  35.75 277.4
## 2 -854.6331 -78.25 233.0
## 3 -702.1706  80.00 294.1
## 4 -935.8824 -34.75 288.6
## 5 -249.0226 190.25 206.5
## 6 -401.1268 195.50 267.3
\end{verbatim}
...
## -77.921 -13.169  -0.579  15.589  55.405 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 10.32672   26.37681   0.392    0.697    
## x1           1.95805    0.03167  61.832   <2e-16 ***
## x2          -3.03767    0.10609 -28.634   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 27.81 on 72 degrees of freedom
## Multiple R-squared:  0.9841, Adjusted R-squared:  0.9836 
## F-statistic:  2224 on 2 and 72 DF,  p-value: < 2.2e-16
\end{verbatim}
...
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for gaussian family taken to be 773.5935)
## 
##     Null deviance: 3495888  on 74  degrees of freedom
## Residual deviance:   55699  on 72  degrees of freedom
## AIC: 716.61
## 
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(mod}\OperatorTok{$}\NormalTok{residuals)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{geom\_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ trees}\OperatorTok{$}\NormalTok{Diameter, }\DataTypeTok{y =}\NormalTok{ mod}\OperatorTok{$}\NormalTok{residuals))}\OperatorTok{+}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Residual plot"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(fit}\OperatorTok{$}\NormalTok{residuals)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{ggplot}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ mtcars}\OperatorTok{$}\NormalTok{wt, }\DataTypeTok{y =}\NormalTok{ fit}\OperatorTok{$}\NormalTok{residuals))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom\_hline}\NormalTok{(}\DataTypeTok{yintercept =} \DecValTok{0}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Weight (in thousands of lbs)"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"residuals"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Residual plot"}\NormalTok{)}
