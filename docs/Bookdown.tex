...
\begin{verbatim}
##           y     x1    x2
## 1 -887.1755 -50.50 265.7
## 2 -395.0929 140.00 215.3
## 3 -711.1176  44.75 266.0
## 4 -649.4375  99.50 284.2
## 5 -534.8697 160.25 292.8
## 6 -301.3693 167.75 208.2
\end{verbatim}
...
## -80.734 -14.173   1.144  14.466  69.858 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 30.23712   28.52287    1.06    0.293    
## x1           1.99093    0.03167   62.86   <2e-16 ***
## x2          -3.10391    0.11249  -27.59   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 26.97 on 72 degrees of freedom
## Multiple R-squared:  0.9848, Adjusted R-squared:  0.9844 
## F-statistic:  2332 on 2 and 72 DF,  p-value: < 2.2e-16
\end{verbatim}
