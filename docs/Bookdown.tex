...
\begin{verbatim}
##           y     x1    x2
## 1 -417.3807 233.75 296.1
## 2 -500.5594 182.00 293.1
## 3 -801.3577 -64.00 219.5
## 4 -784.3837  37.25 289.2
## 5 -234.5331 201.50 216.0
## 6 -884.8346  -4.00 296.8
\end{verbatim}
...
## -67.685 -11.686   2.294  12.590  73.343 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -37.78447   25.53607   -1.48    0.143    
## x1            2.04716    0.02713   75.45   <2e-16 ***
## x2           -2.85890    0.09812  -29.14   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 24.83 on 72 degrees of freedom
## Multiple R-squared:  0.9896, Adjusted R-squared:  0.9893 
## F-statistic:  3419 on 2 and 72 DF,  p-value: < 2.2e-16
\end{verbatim}
